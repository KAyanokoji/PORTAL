...
import DropdownMenu from '../common/pickers/drop-down';
  ...
  return (
    <nav className="bg-white border-gray-200 dark:bg-gray-900 shadow-md ">
      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="relative group flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      <button
        type="button"
        className="text-sm relative inline-block rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
        id="user-menu-button"
        aria-expanded="false"
      >
        <User2Icon />
      ...
      {/* Dropdown appears bottom-left of button */}
      <DropdownMenu />
    </div>
